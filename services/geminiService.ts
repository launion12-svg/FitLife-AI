...
const getPlanPrompt = (profile: UserProfile, language: 'en' | 'es'): string => {
    ...
    - Días disponibles para entrenar: ${profile.workoutDays} días/semana
    ...
    2.  **Plan de Entrenamiento**: Crea un programa de entrenamiento estructurado para los ${profile.workoutDays} días disponibles.
        ...
        - Para cada día de entrenamiento, especifica el enfoque (ej. 'Empuje', 'Tirón', 'Piernas', 'Cuerpo Completo').
        - Lista 5-7 ejercicios por entrenamiento. Para cada ejercicio, especifica un 'id' único, nombre, series, repeticiones y tiempo de descanso.
        - Proporciona una 'description' (descripción) clara y concisa para CADA ejercicio, explicando la forma correcta y los músculos trabajados. Esta descripción es obligatoria y debe ser apta para principiantes.
    ...
    - Available days for workout: ${profile.workoutDays} days/week
    ...
    1.  **Nutrition Plan**: Create a detailed 7-day meal plan.
        ...
        - Use common ingredients found in Spanish supermarkets like Mercadona or Aldi.
        - The day names must be "Monday", "Tuesday", etc.
    2.  **Workout Plan**: Create a structured workout schedule for the ${profile.workoutDays} available days.
        ...
        - For each workout day, specify the focus (e.g., 'Push', 'Pull', 'Legs', 'Full Body').
        - List 5-7 exercises per workout. For each exercise, specify a unique 'id', name, sets, reps, and rest time.
        - Provide a clear and concise 'description' for EVERY exercise, explaining the correct form and muscles worked. This description is mandatory and should be beginner-friendly.
