...
export const HomeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.12 0l8.955 8.955M3 10.5v9.75a1.5 1.5 0 001.5 1.5h4.5a1.5 1.5 0 001.5-1.5V15a.75.75 0 01.75-.75h1.5a.75.75 0 01.75.75v5.25a1.5 1.5 0 001.5 1.5h4.5a1.5 1.5 0 001.5-1.5V10.5M8.25 21V15a3.75 3.75 0 013.75-3.75h0a3.75 3.75 0 013.75 3.75v6" />
  </svg>
);

export const PlateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 9.75v.001c.001.034.001.067.001.1a12 12 0 11-12.002-12 11.986 11.986 0 0111.986 11.986c0 .033 0 .066-.001.1zM12 6.75v10.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12c0-1.06.316-2.064.86-2.919" />
  </svg>
);

export const DumbbellIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h1.5A2.25 2.25 0 0112 6v2.25m0 0v2.25m0-2.25H12M18 17.122V18a2.25 2.25 0 01-2.25 2.25h-1.5A2.25 2.25 0 0112 18v-2.25m0 0v-2.25m0 2.25H12M12 12l-6 6M12 12l6-6m-6 6l6 6" />
  </svg>
);
...
export const TargetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 15.91L12 12m0 0l-3.91 3.91M12 12l3.91-3.91M12 12L8.09 8.09" />
  </svg>
);
...
export const DocumentSearchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.5h3.846A3.375 3.375 0 0021 17.25V7.5a3.375 3.375 0 00-3.375-3.375h-5.625a3.375 3.375 0 00-3.375 3.375v1.5m-3.375 5.625v1.5a3.375 3.375 0 003.375 3.375h1.5a3.375 3.375 0 003.375-3.375v-1.5m-3.375-3.375a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h.008v.008H8.25v-.008z" />
    </svg>
);
